...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    print(workers, "GGGGGGGGGGGGGGGGGGGGGG")
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/yolov5s_hat.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/voc_hat.yaml', help='dataset.yaml path')
